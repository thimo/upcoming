...
- **Keyboard-navigatie in de popup** (2026-06-12): ↓/→ volgende dag, ↑/← vorige dag, met ⌘ een hele week; springt naar de dichtstbijzijnde dag mét events in de looprichting (lege dagen hebben geen sectie). Escape sluit (bestond al).
