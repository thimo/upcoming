...
- **Design: heel dicht bij Fantastical** (screenshot 2026-06-11), maar **niet** de twee-tonen split — gewoon light. **Koerswijziging 2026-06-12: design volgt voortaan Apple Calendar waar dat afwijkt van Fantastical** — eerste toepassing is de maand-header: maand bold + jaartal light in dezelfde kleur (niet meer jaartal-rood), ‹ Today ›-cluster rechts met ronde grijze chevron-knoppen en een Today-capsule (springt grid + lijst terug naar vandaag).
